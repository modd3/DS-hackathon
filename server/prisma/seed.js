...
const SLA_RULES = [
  {
    ...
    description: 'Initial customer inquiry must be acknowledged and moved to Design within 2 minutes.',
    stage: 'INQUIRY',
    maxDurationMins: 2,
  ...
  },
  {
    ...
    description: 'Engineering design phase must be completed within 3 minutes of handoff.',
    stage: 'DESIGN',
    maxDurationMins: 3,
    alertChannels: ['IN_APP', 'EMAIL'],
    alertRecipients: [RECIPIENT],
  ...
  },
  {
    ...
    description: 'Quotation must be submitted to the customer within 1 minute of design approval.',
    stage: 'QUOTATION',
    maxDurationMins: 1,
  ...
  },
  {
    ...
    description: 'Delivery must be completed within 3 minutes of confirmed order.',
    stage: 'DELIVERY',
    maxDurationMins: 3,
    alertChannels: ['IN_APP', 'EMAIL'],
    alertRecipients: [RECIPIENT],
